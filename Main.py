...
# Form implementation generated from reading ui file 'coqt.ui'
#
...
class Ui_MainWindow(object):
    ...
    def get_data(self):
        ...
        if latest_data[9] == '0':
            ...
            self.country_flag.setPixmap(QtGui.QPixmap("images/flag_transparent.png"))

        else:
            full_path = 'images/' + 'flag' + '.png'
            urllib.request.urlretrieve(latest_data[9], full_path)
            self.country_flag.setPixmap(QtGui.QPixmap("images/flag.png"))
    ...
    def get_plots(self):
        ...
        if latest_plot_data[0] == '0':
            ...
            if self.total_cases_box.isChecked() == True:
            ...
            if self.total_recoveries_box.isChecked() == True:
            ...
            if self.total_deaths_box.isChecked() == True:
            ...
            if self.daily_cases_box.isChecked() == True:
            ...
            if self.daily_deaths_box.isChecked() == True:
    ...
    def setupUi(self, MainWindow):
        ...
        self.label_enter_country_name.setStyleSheet("color: rgb(255, 255, 255);")
...
"background-color: rgb(10, 10, 14);")
        ...
        self.get_data_button.setStyleSheet("color: rgb(255, 255, 255);\n"
"background-color: rgb(0, 0, 68);")
        ...
        self.label_plots_of.setStyleSheet("color: rgb(255, 255, 255);")
        ...
        self.total_cases_box.setStyleSheet("color: rgb(255, 255, 255);")
        ...
        self.total_recoveries_box.setStyleSheet("color: rgb(255, 255, 255);")
        ...
        self.total_deaths_box.setStyleSheet("color: rgb(255, 255, 255);")
        ...
        self.daily_cases_box.setStyleSheet("color: rgb(255, 255, 255);")
        ...
        self.get_plots_button.setStyleSheet("color: rgb(255, 255, 255);\n"
"background-color: rgb(0, 0, 68);")
        ...
        self.label_total_cases.setGeometry(QtCore.QRect(520, 240, 261, 16))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.label_total_cases.setStyleSheet("color: rgb(255, 255, 255);")
        self.label_total_cases.setObjectName("label_total_cases")
        self.label_total_recoveries = QtWidgets.QLabel(self.centralwidget)
        self.label_total_recoveries.setGeometry(QtCore.QRect(520, 270, 261, 16))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.label_total_recoveries.setStyleSheet("color: rgb(255, 255, 255);")
        ...
        self.label_total_deaths.setGeometry(QtCore.QRect(520, 300, 261, 16))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.label_total_deaths.setStyleSheet("color: rgb(255, 255, 255);")
        self.label_total_deaths.setObjectName("label_total_deaths")
        self.label_6 = QtWidgets.QLabel(self.centralwidget)
        self.label_6.setGeometry(QtCore.QRect(750, 520, 81, 16))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(6)
        font.setBold(False)
        ...
        self.label_total_active.setGeometry(QtCore.QRect(520, 330, 261, 16))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.label_total_active.setStyleSheet("color: rgb(255, 255, 255);")
        self.label_total_active.setObjectName("label_total_active")
        self.label_cases_per_1m = QtWidgets.QLabel(self.centralwidget)
        self.label_cases_per_1m.setGeometry(QtCore.QRect(520, 356, 261, 20))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.label_cases_per_1m.setStyleSheet("color: rgb(255, 255, 255);")
        self.label_cases_per_1m.setObjectName("label_cases_per_1m")
        self.label_deaths_per_1m = QtWidgets.QLabel(self.centralwidget)
        self.label_deaths_per_1m.setGeometry(QtCore.QRect(520, 390, 261, 16))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.label_deaths_per_1m.setStyleSheet("color: rgb(255, 255, 255);")
        self.label_deaths_per_1m.setObjectName("label_deaths_per_1m")
        self.label_total_tests = QtWidgets.QLabel(self.centralwidget)
        self.label_total_tests.setGeometry(QtCore.QRect(520, 420, 261, 16))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.label_total_tests.setStyleSheet("color: rgb(255, 255, 255);")
        self.label_total_tests.setObjectName("label_total_tests")
        self.label_tests_per_1m = QtWidgets.QLabel(self.centralwidget)
        self.label_tests_per_1m.setGeometry(QtCore.QRect(520, 445, 261, 21))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.label_tests_per_1m.setStyleSheet("color: rgb(255, 255, 255);")
        self.label_tests_per_1m.setObjectName("label_tests_per_1m")
        self.label_country = QtWidgets.QLabel(self.centralwidget)
        self.label_country.setGeometry(QtCore.QRect(520, 210, 261, 21))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.label_country.setStyleSheet("color: rgb(255, 255, 255);")
        ...
        self.daily_deaths_box.setStyleSheet("color: rgb(255, 255, 255);")
        self.daily_deaths_box.setObjectName("daily_deaths_box")
        self.line_2 = QtWidgets.QFrame(self.centralwidget)
        self.line_2.setEnabled(True)
        self.line_2.setGeometry(QtCore.QRect(0, 500, 831, 21))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(6)
        font.setBold(False)
        ...
        self.label_world_infected.setStyleSheet("color: rgb(255, 255, 255);")
        ...
        self.frame_2.setGeometry(QtCore.QRect(320, 20, 191, 91))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_world_dead.setStyleSheet("color: rgb(255, 255, 255);")
        ...
        self.frame_3.setGeometry(QtCore.QRect(600, 20, 191, 91))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_world_recovered.setStyleSheet("color: rgb(255, 255, 255);")
        ...
        self.line_3.setGeometry(QtCore.QRect(0, 120, 841, 21))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setBold(False)
        font.setWeight(50)
        self.line_3.setFont(font)
        self.line_3.setStyleSheet("color: rgb(0);")
        ...
        self.label_plots_of_2.setStyleSheet("color: rgb(255, 255 ,255);")
...
"background-color: rgb(12, 12, 16);")
        ...
        self.country_flag.setGeometry(QtCore.QRect(600, 140, 114, 60))
        ...
        self.label_background_picture = QtWidgets.QLabel(self.centralwidget)
        self.label_background_picture.setGeometry(QtCore.QRect(-70, -10, 921, 571))
        self.label_background_picture.setText("")
        self.label_background_picture.setPixmap(QtGui.QPixmap(":/Images/images/background_latest.jpg"))
        self.label_background_picture.setScaledContents(True)
        self.label_background_picture.setObjectName("label_background_picture")
        self.label_plots_of_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_plots_of_3.setGeometry(QtCore.QRect(10, 450, 221, 21))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(8)
        font.setBold(False)
        ...
        self.label_plots_of_3.setStyleSheet("color: rgb(255, 255 ,255);")
        ...
        self.label_plots_of_4.setStyleSheet("color: rgb(255, 255 ,255);")
        self.label_plots_of_4.setObjectName("label_plots_of_4")
        self.label_background_picture.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "COVID-19 Tracker v1.0"))
        ...
        self.label_plots_of.setText(_translate("MainWindow", "Plot grahps of:"))
        ...
        self.label_6.setText(_translate("MainWindow", "© Rahul Shagrithaya"))
